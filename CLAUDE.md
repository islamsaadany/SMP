...
- **THE NOTICE SPEAKS THE USER'S LANGUAGE (§230.2):** Islam, on §201's wall —
  *"too technical for the users"*, then *"make a very simple user message"*,
  ...
  the absence.
- **THE SAVE SAYS SO IN THE CORNER, AND THE GOOD NEWS LEAVES (§291):**
...
- **A REFUSAL STOPS THE WORK AND CARRIES TWO DOORS (§291):** Islam's shape.
...
- **THE SPREAD IS THE TENANT'S OWN BANDS (§291):** `bandSpread()` reads
  ...
  **AND THEN THE STRIP ITSELF (§291.2)** — *"for the performance view remove it
  ...
  exercise — §24's own case. Deleted, design written up in §291, one `git show`
