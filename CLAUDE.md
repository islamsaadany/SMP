...
- **A HIDDEN ROW OWES NOTHING (§288):** Islam — *"for the hidden tactics or
  ...
  **§214.4 with the same sign**, answered the same way: `missWord(row)` asks
  ...
  (§24 — callerless since §249). **2 red** on the pre-§288 build. **AND TWO OF
...
*Last Updated: 2026-09-04 &mdash; **&sect;288: a hidden row owes nothing**
(built 2026-09-02 as &sect;250; main took that number and everything to
&sect;287 while it waited, so it was renumbered at the merge, never at
authoring time).
...
*Earlier: **&sect;278.3: the objectives table, and a
