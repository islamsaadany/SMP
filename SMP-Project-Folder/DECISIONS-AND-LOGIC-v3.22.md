...
## 93 · The strategy tab is the office's, people open where they work, and Report goes solid (v3.25)
...
### 93.1 "Don't allow anyone else other than the SMO and super user to edit the strategy tab"
...
### 93.3 Reordering is authoring, and it was already being refused
...
### 93.4 Three drifts, all in the direction the screen says yes and the server says no
...
### 93.5 And the most important test in the suite could not fail
...
now, and the suite gained the two halves §93 needed on both sides of the switch.
...
### 93.6 "The default opening page for the users is on the plan in the strategy"
...
### 93.7 The target was the one on screen, not the one being asked about
...
corrected; found only because §93.6 made that path the FIRST thing that runs.

### 93.8 Report is the one solid button in the product
...
### 93.9 And the move was reversed the same day, for a better reason
...
§93.8's first half is therefore **not built**: the unit's Performance page keeps
