...
| `../../design-mockups/client-door/2026-09-08_client-door.html` | Every client gets a door of its own: Raya's sign-in at its own address wearing Raya's mark on the card, with Forefront's root door beside it unchanged. Built from the real door's stylesheet. **Approved and built** (&sect;303.36) |
