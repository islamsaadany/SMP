...
**`DECISIONS-AND-LOGIC-v2.7.md`** — every decision with its reasoning,
...
**`strategy-management-platform-v2.7.html`** — the built prototype. One file,
