...
**`DECISIONS-AND-LOGIC-v2.6.md`** — every decision with its reasoning,
...
**`strategy-management-platform-v2.6.html`** — the built prototype. One file,
