...
**`DECISIONS-AND-LOGIC-v3.6.md`** — every decision with its reasoning,
...
**`strategy-management-platform-v3.6.html`** — the built prototype. One file,
