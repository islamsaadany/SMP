...
**`DECISIONS-AND-LOGIC-v3.7.md`** — every decision with its reasoning,
...
**`strategy-management-platform-v3.7.html`** — the built prototype. One file,
