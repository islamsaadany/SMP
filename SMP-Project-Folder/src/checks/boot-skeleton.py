...
class H(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path.startswith("/api/state"):
            ...
            return
        # A CLIENT'S OWN DOOR (§313.36): /raya-trade/sign-in is the gate,
...
with sync_playwright() as p:
    ...
    #
    # §230.2 RESHAPED THE CARD AT ISLAM'S DIRECTION: "the message after 8
    ...
    ck("...and the removed way past stays removed (§230.2)", w["noWayPast"], w)
    ...
    # and since §313.36 lands on the door of the client this page was served
    ...
    # ── 6 · A LATE ANSWER STILL LANDS (§230) ────────────────────────
    ...
    # the live tenant painted in place. On the pre-§230 build the wall
