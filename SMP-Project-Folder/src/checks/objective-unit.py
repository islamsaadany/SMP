...
with sync_playwright() as pw:
    ...
    # §237: there is one layout now, so nothing selects it.
    ...
    # §237 DELETED THE CHIP LAYOUT at Islam's instruction: *"the other toggle
    ...
    print("\n── 6 · one layout, and it carries the whole figure (§237)")
