...
def add_role(pg, key):
    """OPENS THE ROLES LIST (§366). There is no "+ role" control any more: the
...
with sync_playwright() as pw:
    ...
    # WHAT THE LIST SHOWS BEFORE ANYTHING IS PICKED. §366 made the cell a
    ...
    # so an empty string there meant "nothing is being offered" (§366 replaced
