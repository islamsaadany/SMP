...
{ g: "Reporting", items: [
  ...
  { id: "draft-vs-submit", q: "What is the difference between Save draft and Submit?",
    a: "Save draft saves your progress without submitting it to the Strategy " +
       ...
       "for the cycle." },
  { id: "cycle-open", q: "How do I know whether the reporting cycle is open?",
    a: "Two places say so. The welcome screen when you sign in carries a chip naming " +
       "the cycle while it is open, and your unit's <b>Performance</b> page shows " +
       "<b>Report</b> for as long as the window lasts." +
       "|When it has closed, that page says so and names the cycle, so you are never " +
       "left guessing which of the two it is." },
...
{ g: "The platform and support", items: [
  ...
  { id: "assistant-no-data", q: "Can the assistant tell me my own figures, or whether " +
       "something has been submitted?",
    a: "No. It knows how the platform works and can see none of your organisation's own " +
       "information \u2014 no figures, no targets, no scores, and nothing about where any " +
       "unit has got to." +
       "|Ask it how something works and it will answer. Ask it what a number is and it " +
       "will pass the question to the Strategy Office, who can see it." },
