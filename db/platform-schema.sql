...
CREATE TABLE IF NOT EXISTS clients (
  ...
  -- WHOSE REGISTER IS IT (§303.31). A client CREATED HERE has its register
  ...
  -- adds nobody to it: each account says which existing row it is (§303.30).
  --
...
-- A CLIENT MAY HAVE MORE THAN ONE SUPER USER (§303.26, Islam 2026-09-01: "a
...
-- (§303.20), so there is no client that can become unreachable.
