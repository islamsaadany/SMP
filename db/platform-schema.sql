...
--
-- WHY A SCHEMA PER CLIENT AT ALL (§36.2, spec 042). readState and writeState
...
CREATE TABLE IF NOT EXISTS clients (
  ...
  -- WHOSE REGISTER IS IT (§313.31). A client CREATED HERE has its register
  ...
  -- adds nobody to it: each account says which existing row it is (§313.30).
  --
...
-- A CLIENT MAY HAVE MORE THAN ONE SUPER USER (§313.26, Islam 2026-09-01: "a
...
-- (§313.20), so there is no client that can become unreachable.
