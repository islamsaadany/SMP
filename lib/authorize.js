...
/* §261: which subjects a master presentation runs through, and in what order.
...
function collect(stored, incoming, w) {
  ...
  /* §261: the master presentation's running order. Deliberately NOT `setup`
...
function authorize(stored, incoming, person) {
  ...
  changes.forEach(function (ch) {
    ...
    switch (ch.kind) {
      ...
      /* ── THE ORDER A REVIEW RUNS IN (§261) ──────────────────────────
