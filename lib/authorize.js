...
const FN_KNOWN = FN_SETUP.concat(UNIT_FOUNDATION,
  ["key", "items", "keyObjectives", "swot", "perf", "exec", "pend",
   /* §321: a supporting function holds its own projects now. It is in the
...
function collectFunction(key, sf, iff, add, w) {
  ...
  if (String(sf.format) === "pillars") {
    ...
    /* §321 classified the function's own plan; anything else FN_KNOWN speaks
...
/* ── A LIST OF PROJECTS, CLASSIFIED (§321) ────────────────────────────────
