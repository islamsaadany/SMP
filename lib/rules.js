...
var GAP_OPTIONAL = { tactic: ["collaborators"],
  ...
  /* THE OTHER DIRECTION: a month count written the way the cycle writes it
     (§298). `whenMonths` reads every shape the product has ever stored; this
     ...
     the cycle's `to`, `name` and `due`, and since §298 `to` is the review point
  ...
  /* ── THE CONTINGENCY FILES (spec 030) ────────────────────────────────
     ...
     review day consults none of that arithmetic. (§298 has since taken one of
