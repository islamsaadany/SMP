...
var GAP_OPTIONAL = { tactic: ["collaborators"],
  ...
  /* ── THE CONTINGENCY FILES (spec 030) ────────────────────────────────
     ...
     confusion."* He is right about the three that are there — `from`/`to` is
     the stretch of year, `due` is when the units hand figures in, and
     `asOfMonth` is the month the figures are MEASURED against (§239) — and
     the review day consults none of that arithmetic. It changes no score, no
