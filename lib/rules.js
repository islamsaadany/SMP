...
var GAP_OPTIONAL = { tactic: ["collaborators"],
  ...
  var CHAT_DEFAULTS = Object.freeze({
    ...
    popup: false,
    rep: "",
    /* ── HOW LONG THE PLATFORM COLLECTS BEFORE IT EMAILS (§169, §262) ──
       ...
       §262 stopped presence deciding anything about email — *"even if I'm at
       ...
       exactly the duplication he objected to in §261.1), the SAME key
       changes what it means. One box, one number, relabelled.
  ...
  /* WHAT THE SCREEN MEANS BY "they have the platform open" (§262). Not a
  ...
  /* ── IS THERE ANYTHING OLD ENOUGH TO EMAIL? (§262) ────────────────
