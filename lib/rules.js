...
(function (root, factory) {
  ...
  /* ══ WHAT SOMEBODY IS CALLED, SHORT (§129.7) ═══════════════════════════
     Moved here from config-data.js, where it had always lived, because the
     PLAN now stores what the register's Name column shows (§129.7) and
  ...
  function namedOn(row, person) {
    ...
    /* THE NAME THE REGISTER SHOWS COUNTS TOO (§129.7). The plan's owner and
       ...
       platform back where §129.1 found it: 32 of 78 tactics owned by somebody
