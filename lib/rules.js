...
(function (root, factory) {
  ...
  function W(o) {
    ...
    return {
      ...
      focusOff: !!o.focusOff,
      naming: !!o.naming,
      /* §132: a project's owner is a Contributor of its function, and the
  ...
  function personRoles(w, p) {
    ...
    /* §132: THE SAME FLOOR ON A FUNCTION'S PROJECTS. A function's custodian
  ...
  /* §132: Is this person named on any of this function's projects? The
     ...
     owner; its floor is deliberately not derived here (flagged in §132.5). */
