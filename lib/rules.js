...
(function (root, factory) {
  ...
  var GAP_FIELDS = {
    ...
    /* §176: THE PAGE ALREADY CALLED THESE MISSING. A project pane prints the
  ...
  /* ONE WALK, ASKED FOR A STATE (§176). `editingRoles` and `fillingRoles`
  ...
  /* ── AND A BOUNDED ROLE FILLS ONLY WHAT IT HOLDS (§176) ──────────
