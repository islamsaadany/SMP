...
(function (root, factory) {
  ...
  /* ── 2 · Areas (§37; the own pair split in two, §116) ───────────
  ...
  /* THE STRATEGY DEFAULTS ARE §94 WRITTEN AS CELLS (§116). Edit starts with
  ...
  function areaFor(area, w, r, target) {
    /* THE STRATEGY PAGES RESOLVE TO THEIR OWN HALF (§116). An OTHER unit or
  ...
  /* May this person AUTHOR this page — write what was agreed, as opposed to
     ...
     §116 MOVES §94'S LOCK FROM A HARD RULE TO THE STRATEGY HALF'S GRANT.
  ...
  function mayArrange(w, person, target) {
    ...
    /* §116 MOVED THE PLAN PAGE'S GRANT TO THE STRATEGY HALF, WHICH A HOLDER
  ...
  /* The same pairing for the Reporting half (§116). */
