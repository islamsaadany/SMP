...
async function ensureReadyOnce(client) {
  ...
  try {
    ...
    /* §253, after the seed and both migration phases: it reads the graph the
...
/* ── THE BLANK LINES ALREADY IN A TENANT'S PLAN (§253) ────────────────
...
const HEAL_ONE_LINE = "040-a-title-is-one-line.js";
