...
async function ensureReady(client) {
  ...
  try {
    ...
    /* Bootstrap: with no credentials at all, the SMO can sign in with the
       gate's original password and is forced to choose a real one at once.
       Never touched again after the first person exists. */
