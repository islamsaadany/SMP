...
/* THE THREE THAT NEED A BROWSER, NAMED RATHER THAN SKIPPED (§54.5). Each
   ...
   working build broken (§100.3). None of the three draws My reporting. The
   set is ASSERTED below, so a fourth file growing that dependency is a
   failure here rather than a silent omission. */
const NEEDS_A_DOCUMENT = ["history.js", "safety.js", "sync.js"];
const threw = [];
...
ck("only the three that need a browser are missing",
