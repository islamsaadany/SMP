/* THE REPORTS, AS A TAB IN THE PLATFORM (§376, Islam 2026-09-20).
   ...
   AND SINCE §380 THE ROW IS WHAT THE DOCUMENT WAS STAMPED WITH rather than
...
console.log("\n2 · the section row is what the document was stamped with");
{
  ...
  /* ASSERTED AS AN AGREEMENT WITH THE STAMP, never as a typed list (§94.8),
     and since §380 the stamp is WHAT THIS CLIENT HAS rather than what the
  ...
  /* §380, BOTH ENDS (§94.2). A build that went on reading the module's whole
