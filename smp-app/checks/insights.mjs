...
try {
  ...
  /* §382, AND IT IS A REWRITE RATHER THAN A LOOSENING (§218, §214.3). This
  ...
  /* REWRITTEN with the decision above (§218): it asked for one category by
     ...
     and the second is §382's own rule — the row says what has been PUBLISHED,
...
section("§14 · which filters a person is offered (§382)");
{
