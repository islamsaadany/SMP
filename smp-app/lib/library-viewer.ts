/* ── WHO IS LOOKING AT THE LIBRARY, AND WHAT THEY HAVE IN IT ─────────────
   ...
   that person actually has anything under (§380).
...
/* WHAT THE PLATFORM DOCUMENT CARRIES FOR THE REPORTS TAB (§380), in the shape
...
/* THE SAME QUESTION THE MODULE'S OWN PAGE ASKS (§380, §53.5). Two hosts draw
