/* ══ THE EMAIL THE PLATFORM SENDS (§72) ═══════════════════════════════════
   ...
   ──────────────────────────────────────────────────────────────────────── */
/* ── ONE BUILDER, RUN ON BOTH SIDES (§293, §42's rule applied to an email) ──
...
(function (root, factory) {
  ...
  function greetPara(g, colour){
    ...
    /* THE RULES, WHEREVER THIS IS RUNNING (§293). In the browser they are a
    ...
    var R = (typeof SMPRules !== "undefined") ? SMPRules
          : (typeof require !== "undefined" ? require("./rules.cjs") : null);
    if (!R) return "";
  ...
  /* ── THE SMALL PRINT, WHEN THE TENANT HAS NOT WRITTEN ANY (§293) ────
