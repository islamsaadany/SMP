...
var TOUR = (function(){
  ...
  var STORIES = {
    custodian: {
      ...
      steps: [
        /* THE WELCOME CARD CARRIES A DESTINATION, and that is the point:
           replaying from the Knowledge base used to draw it over the
           Knowledge base. The platform is moved to the person's own place
           before the first word is read. */
        { kind:"welcome", dest:"$own", tab:"strategy", sec:"plan",
